    ...
    <footer className="bg-primary-800 text-white pt-16 pb-8">
      <div className="max-container">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h4 className="text-xl font-bold mb-4">Masashi<span className="text-orange-400">POS</span></h4>
            <p className="text-gray-300 mb-4">
              Streamlined inventory and point-of-sale solutions for modern businesses.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/products" className="text-gray-300 hover:text-orange-400 transition-colors">Products & Solutions</Link></li>
              <li><Link to="/case-studies" className="text-gray-300 hover:text-orange-400 transition-colors">Case Studies</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/products#retail" className="text-gray-300 hover:text-orange-400 transition-colors">Retail</Link></li>
              <li><Link to="/products#pharmacy" className="text-gray-300 hover:text-orange-400 transition-colors">Pharmacy</Link></li>
              <li><Link to="/products#supermarket" className="text-gray-300 hover:text-orange-400 transition-colors">Supermarket</Link></li>
              <li><Link to="/products#warehouse" className="text-gray-300 hover:text-orange-400 transition-colors">Warehouse</Link></li>
              <li><Link to="/products#restaurant" className="text-gray-300 hover:text-orange-400 transition-colors">Restaurant</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 text-center text-gray-400">
          <p>&copy; {currentYear} Masashi POS. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
